...
#### Option 2: Use stock firmware, set brake light always on
Using one of the the apps above to set your brake light to 'always on' (no firmware flashing required).
